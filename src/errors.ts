...
export class UnsupportedGrantType extends Error {
	constructor() {
		super(
			`An internal error occurred that shouldn't happen. This library is outdated.`
		);
...
export class IncorrectClientCredentials extends Error {
	constructor() {
		super(
			`An internal error occurred that shouldn't happen. Please contact the developers of aspkg.`
		);
